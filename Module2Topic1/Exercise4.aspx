...
<body>
   ...
   ErrorMessage="Please choose a candidate">
        ...
        <asp:RangeValidator runat="server" ControlToValidate="age" MinimumValue="0" MaximumValue="100" Type="Integer" ErrorMessage="Age must be between  0 and  100."></asp:RangeValidator>
        ...
        <asp:RegularExpressionValidator runat="server" ControlToValidate="email" ValidationExpression="^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$" ErrorMessage="Please enter a valid email address."></asp:RegularExpressionValidator>
        ...
        <asp:CompareValidator runat="server" ControlToCompare="email" ControlToValidate="confirmEmail" Operator="Equal" ErrorMessage="Email and confirmation email must match."></asp:CompareValidator>


        <asp:Button Text="Submit" runat="server" OnClick="SubmitForm" UseSubmitBehavior="false" />
